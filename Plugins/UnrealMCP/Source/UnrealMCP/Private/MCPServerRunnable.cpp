...
const int32 SocketBufferSize = 8192;
    ...
    while (bRunning)
    {
        ...
        if (ListenerSocket->HasPendingConnection(bPending) && bPending)
        {
            ...
            if (ClientSocket.IsValid())
            {
                ...
                int32 ClientSocketBufferSize = 65536;  // 64KB buffer
                ClientSocket->SetSendBufferSize(ClientSocketBufferSize, ClientSocketBufferSize);
                ClientSocket->SetReceiveBufferSize(ClientSocketBufferSize, ClientSocketBufferSize);
